...
model = models.load_model('D:\Blind Aid Glasses\Graduation project\ResNet50_Currency.h5')
Labels = ["Ten", "One Hundred", "Twenty", "Two Hundred", "Five", "Fifty", "none"]
...
while True:
    ...
    try:
        ...
        if Labels[class_index] != "none" and confidence >= 0.90:
            draw_label(frame, f'Label: {Labels[class_index]} ({confidence * 100:.1f}%)', (20, 20), (255, 0, 0))
